...
export default function Contact() {
	...
	async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
		...
		if (response.status === 200) {
			toast("Thank you!", "Message sent successfully. I will get back to you as soon as possible.", true);
		} else {
		...
		<section data-aos="fade-up" id="contact" className="pt-48 lg:px-36">
			<div className="w-full h-full flex flex-col items-center lg:items-start gap-4">
				...
				<p className="text-gray-600 text-lg text-center lg:text-left">
					Let&apos;s bring your project to life! Whether you need a custom website, tech support, or have a unique challenge, I&apos;m here to help. Drop me a message and
					let&apos;s chat!
				</p>
				<form onSubmit={handleSubmit} className="w-full">
					<div className="flex flex-col gap-2">
						<div className="flex">
							<div className="flex flex-col w-full lg:w-2/3 xl:w-1/2">
								...
								<label htmlFor="name" className="font-semibold text-lg">
									Name
									<p className="font-normal text-base text-gray-600">What can I call you?</p>
								</label>
								<input
									name="name"
									type="text"
								...
								<label htmlFor="email" className="font-semibold text-lg">
									Email
									<p className="font-normal text-base text-gray-600">Where can I get back to you?</p>
								</label>
								<input
									name="email"
									type="email"
								...
								<label htmlFor="subject" className="font-semibold text-lg">
									Subject
									<p className="font-normal text-base text-gray-600">What&apos;s this about?</p>
								</label>
								<input
									name="subject"
									type="text"
							...
							<div className="hidden lg:flex flex-col text-sm font-semibold lg:w-2/3 xl:w-1/2">
								<div className="flex gap-2 justify-center items-center">
									...
									<span>You can email me at contact@robrust.dev</span>
								</div>
								<div className="flex justify-center items-center">
									<Image src="/solution_mindset.svg" alt="solution mindset" width={500} height={500} />
								</div>
							</div>
						</div>
						{/* Body */}
						<label htmlFor="body" className="font-semibold text-lg">
							Message
							<p className="font-normal text-base text-gray-600">What can I help you with?</p>
						</label>
						<textarea
							name="body"
						...
						<div className="flex flex-col sm:flex-row gap-2 items-center justify-center sm:justify-between">
							<button
								...
								<span className="w-1/2">Submit</span> <div className="w-1/4"></div>
							</button>
							<Link

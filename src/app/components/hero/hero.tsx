...
export default function Hero() {
	const words = ["Software Engineer", "Lifetime Student", "Full Stack Developer", "Web Developer", "Problem Solver", "Freelance Developer"];
	return (
			...
			<div className="flex items-center gap-12">
				<div className="flex flex-col h-full items-center lg:items-start justify-center gap-4">
					...
					<p className="text-sm lg:text-base text-center lg:text-start">
						I help local businesses thrive online with <b>custom websites</b> & <b>reliable tech support</b> in Potsdam, New York.
					</p>
					...
					<div className="flex text-sm justify-center items-center relative  md:ml-0">
						...
						<span className="text-xs text-center md:text-left sm:ml-5 ml-5  md:ml-5 line-clamp-2">Currently accepting clients</span>
					</div>
				</div>
